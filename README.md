...
export function Container() {
  ...
  >({
    ...
    /* Optional: `initialContainerHeight` defines the height of the container on the
...
(index: number) => number
  ...
  <tr>
    ...
    <td><code>number</code></td>
    <td>-</td>
    <td>Minimum index item that can be scrolled to.</td>
  </tr>
  <tr>
    ...
    <td><code>number</code></td>
    <td>-</td>
    <td>Maximum index item that can be scrolled to.</td>
  </tr>
  <tr>
...
<tr>
    <td><code>initialContainerHeight</code></td>
    <td>no</td>
    <td><code>number</code></td>
    <td>-</td>
